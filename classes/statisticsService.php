...
class StatisticsService {
	...
	const REPORTS_WITH_CREATION_DATE = 'SELECT (count(?s) as ?count) ?date  WHERE {?s <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://getyourbikeback.webgefrickel.de/ontology/Report> . ?s <http://purl.org/dc/terms/created> ?date }';
